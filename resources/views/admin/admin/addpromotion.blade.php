          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                เพิ่มข้อมูลหน้าโปรโมชั่น
              </header>
              <form method="POST" enctype="multipart/form-data" action="{{route('admin.storepromotion')}}">
              @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="content" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
