...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('back_end/assets/img/apple-icon.png')}}">
  <link rel="icon" type="image/png" href="{{asset('back_end/assets/img/favicon.png')}}">
  <title>
    ข้าวหมากโบราณ
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- Nucleo Icons -->
  <link href="{{asset('back_end/assets/css/nucleo-icons.css')}}" rel="stylesheet" />
  <link href="{{asset('back_end/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="{{asset('back_end/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{asset('back_end/assets/css/soft-ui-dashboard.css?v=1.0.3')}}" rel="stylesheet" />
</head>
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{asset('back_end/pages/dashboard.html')}}">
              ข้าวหมากโบราณ
            </a>
          ...
          <div class="row">
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="{{ route('register') }}">
                    ...
                    <label>Name</label>
                    <div class="mb-3">
                      <input type="name" name="name" class="form-control" placeholder="name" aria-label="name" aria-describedby="name-addon">
                    </div>
                    <label>Email</label>
                    <div class="mb-3">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('back_end/assets/img/curved-images/sile2.jpg')"></div>
              </div>
            </div>
          </div>
        </div>
